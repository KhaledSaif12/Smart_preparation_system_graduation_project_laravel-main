<header class="header-top" lang="en" dir="rtl"  header-theme="light">
    <meta charset="utf-8">

    <div class="container-fluid header py-1 d-flex" lang="en" >
        <div class="app-header1 header py-1 d-flex justify-content-between">
            ...
            <div class="top-menu d-flex align-items-center">
                ...
                <div class="dropdown d-none d-md-flex">
                    ...
                    <img class="avatar avatar-xs ml-1 align-self-center" src="{{ asset('img/user.jpg')}}" alt=""></a>
                    <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" aria-labelledby="userDropdown">
                        <a class="dropdown-item d-flex pb-3" href="{{url('profile')}}"><i class="ik ik-user dropdown-icon"></i> {{ __('Profile')}}</a>
                        <a class="dropdown-item d-flex pb-3" href="#"><i class="ik ik-navigation dropdown-icon"></i> {{ __('Message')}}</a>
                        <a class="dropdown-item d-flex pb-3" href="{{ url('logout') }}">
